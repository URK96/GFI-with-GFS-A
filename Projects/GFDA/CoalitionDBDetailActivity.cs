...
namespace GFDA
{
    ...
    public class CoalitionDBDetailActivity : BaseAppCompatActivity
    {
        ...
        private readonly int curtainUpIcon = ETC.useLightTheme ? Resource.Drawable.ArrowUp_WhiteTheme : Resource.Drawable.ArrowUp;
        private readonly int curtainDownIcon = ETC.useLightTheme ? Resource.Drawable.ArrowDown_WhiteTheme : Resource.Drawable.ArrowDown;

        int[] analysisButtonIds = 
        { 
            Resource.Id.CoalitionDBDetailAnalysisSelect0, 
            Resource.Id.CoalitionDBDetailAnalysisSelect1, 
            Resource.Id.CoalitionDBDetailAnalysisSelect2, 
            Resource.Id.CoalitionDBDetailAnalysisSelect3, 
            Resource.Id.CoalitionDBDetailAnalysisSelect4 
        };
            ...
            try
            {
                switch (item?.ItemId)
                {
                    ...
                    case Resource.Id.CoalitionDBDetailLink:
                        var pMenu = new AndroidX.AppCompat.Widget.PopupMenu(this, FindViewById<View>(Resource.Id.CoalitionDBDetailLink));

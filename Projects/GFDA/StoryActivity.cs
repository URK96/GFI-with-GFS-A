...
namespace GFDA
{
    ...
    public partial class StoryActivity : BaseAppCompatActivity
    {
        ...
        private void InitializeList()
        {
            ...
            titleList.AddRange(Resources.GetStringArray(Resource.Array.Story_Main));
    ...
    public class StoryListAdapter : RecyclerView.Adapter
    {
        ...
        {
            View view = LayoutInflater.From(parent?.Context).Inflate(Resource.Layout.StoryListLayout, parent, false);

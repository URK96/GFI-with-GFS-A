...
namespace GFDA
{
    internal static class ETC
    {
        ...
        internal static void BasicInitializeApp(Context context)
        {
            ...
            Syncfusion.Licensing.SyncfusionLicenseProvider.RegisterLicense("MTExMTMzMEAzMjMwMmUzNDJlMzBoMU9MUDAvMUQyTGZ5VitiQWVVSDJiTmNvQmdLT0RSS1BidTdUbXpLNUpjPQ==");
        ...
        {
            int langIndex = 0;//int.Parse(sharedPreferences.GetString("AppLanguage", "0"));

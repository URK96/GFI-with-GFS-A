    ...
    public class ExpItemCalc : AndroidX.Fragment.App.Fragment
    {
            ...
            NowExp.TextChanged += delegate 
            {
                switch (ExpTypeList.SelectedItemPosition)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        CalcReport_Fairy(TargetLevel.Value);
                        break;
                    case 2:
                        CalcReport_FST(TargetLevel.Value, TrainerLevel.Value);
                        break;
                }
            };
        ...
        private void CalcReport(int target)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(NowExp.Text))
        ...
        /// </summary>
        /// <param name="target">Set target level</param>
        private void CalcReport_Fairy(int target)
        {
            const int ExpItem = 3000;
        ...
        private void CalcReport_FST(int target, int trainer)
        {
            const int ExpItem = 3000;
